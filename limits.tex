...
\pagestyle{empty}
\outcome{Understand limits of functions given graphically}

\title{Limits of a function given graphically}
...
<<<<<<< HEAD
\begin{image}
\includegraphics[scale=.6]{piecewise1.png}
\end{image}
=======

\includegraphics[.6]{piecewise1.png}
